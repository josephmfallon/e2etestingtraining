...
//     I.fillField("Password", process.env.regular_user_password);
//     I.click('Log in');
//     I.see('Invalid email or password');
// });
...
//     I.fillField("#admin_user_email", process.env.regular_user);
...
//     I.fillField("loginfmt", process.env.regular_user);
//     I.click("Next");
//     I.wait(2);
//     I.fillField('passwd', secret(process.env.regular_user_password));
//     I.wait(2);
//     I.click("Sign in");
//     //I.wait(2);
...
//     I.see(process.env.regular_user);
